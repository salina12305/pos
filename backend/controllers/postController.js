...
const createPost = async (req, res) => {
    try {
        ...
        // Validation: Ensure an image was actually uploaded via Multer
        if (!req.file) {
        ...
        const newPost = await Post.create({
            ...
            author,
            userId,
            image: req.file.filename // Save the unique filename generated by Multer
        });
...
//  Get all posts that are marked as 'published'
...
//  Get all drafts specific to a logged in user
...
//  Toggle likes (Add if not liked, Remove if already liked)
...
//  Add a comment to the comments JSON array
